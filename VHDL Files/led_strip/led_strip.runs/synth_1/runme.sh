...
HD_PWD='C:/Users/abuba/Documents/POV Fan Project/POV_Project/VHDL Files/led_strip/led_strip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log voltage_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source voltage_test.tcl
