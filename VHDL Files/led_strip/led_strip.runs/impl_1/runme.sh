...
HD_PWD='C:/Users/abuba/Documents/POV Fan Project/POV_Project/VHDL Files/led_strip/led_strip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log voltage_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source voltage_test.tcl -notrace
