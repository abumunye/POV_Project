...
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets i_Rst_H_IBUF];
...
set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports { i_Rst_H }]; #IO_L1P_T0_34 Sch=pio[28]
